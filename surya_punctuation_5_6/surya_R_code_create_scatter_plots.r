...
plot_reg <-
  ggplot(dat, aes(node, path)) +
    ...
    geom_segment(
      x = min(dat$node),
      xend = max(dat$node),
      y = 0.0000000001040752 + -0.000000000003461947*min(dat$node),
      yend = 0.0000000001040752 + -0.000000000003461947*max(dat$node),
      color = "black",
      size = 1
    ) +
...
plot_reg_out <-
  ggplot(dat_edit, aes(node, path)) +
    ...
    geom_segment(
      ...
      y = 0.0000000001039552 + -0.000000000003446967*min(dat_edit$node),
      yend = 0.0000000001039552 + -0.000000000003446967*max(dat_edit$node),
      color = "black",
      size = 1
    ) +
    theme_tufte(base_size = 12, base_family = "Arial", ticks = FALSE) +
