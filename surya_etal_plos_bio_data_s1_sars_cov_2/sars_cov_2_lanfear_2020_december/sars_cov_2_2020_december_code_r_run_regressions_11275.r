...
sink("sars_cov_2_2020_december_output_r_regression_path_11275.txt")
cat("===========================\n")
...
sink("sars_cov_2_2020_december_output_r_regression_path_time_11275.txt")
cat("=================\n")
cat("Regression (Null)\n")
cat("=================\n\n")
summary(pgls_null)
...
sink("sars_cov_2_2020_december_output_r_regression_path_time_node_11275.txt")
cat("========================\n")
...
sink(
  "sars_cov_2_2020_december_output_r_regression_path_time_node_continent_11275.txt"
)
cat("========================\n")
cat("Regression (Alternative)\n")
cat("========================\n\n")
...
sink(
  "sars_cov_2_2020_december_output_r_regression_path_time_node_continent_interaction_11275.txt"
)
cat("========================\n")
cat("Regression (Alternative)\n")
cat("========================\n\n")
...
sink(
  "sars_cov_2_2020_december_output_r_regression_path_time_node_interaction_time_11275.txt"
)
cat("========================\n")
cat("Regression (Alternative)\n")
cat("========================\n\n")
...
models <- NULL
models[[1]] <- pgls_alt
sink("sars_cov_2_2020_december_output_r_variance_inflation_factors_11275.txt")
cat("==========================\n")
