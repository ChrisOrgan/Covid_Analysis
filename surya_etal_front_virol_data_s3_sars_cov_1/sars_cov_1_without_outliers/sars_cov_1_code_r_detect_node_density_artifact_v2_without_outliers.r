...
dat$node <- dat$node + 1  # to avoid logging zero
...
sink("sars_cov_1_output_r_node_density_artifact_v2_without_outliers.txt")
cat("=================\n")
...
CairoPDF(
  file = "sars_cov_1_figure_node_density_artifact_v2_without_outliers.pdf",
  width = 4.75,
  height = 2.94
)
print(plot_bias)
