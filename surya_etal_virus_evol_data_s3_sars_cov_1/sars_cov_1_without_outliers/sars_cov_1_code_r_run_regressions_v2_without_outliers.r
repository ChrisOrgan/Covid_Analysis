...
# Read data ----
dat <- read.table(
  "sars_cov_1_data_v2_without_outliers.txt",
  sep = "\t",
  header = TRUE,
  row.names = 1
)
...
sink("sars_cov_1_output_r_regression_path_v2_without_outliers.txt")
cat("===========================\n")
...
sink("sars_cov_1_output_r_regression_path_time_v2_without_outliers.txt")
cat("=================\n")
cat("Regression (Null)\n")
cat("=================\n\n")
summary(pgls_null)
...
sink("sars_cov_1_output_r_regression_path_time_node_v2_without_outliers.txt")
cat("========================\n")
...
sink(
  "sars_cov_1_output_r_regression_path_time_node_interaction_time_v2_without_outliers.txt"
)
cat("========================\n")
cat("Regression (Alternative)\n")
cat("========================\n\n")
...
models <- NULL
models[[1]] <- pgls_alt
sink("sars_cov_1_output_r_variance_inflation_factors_v2_without_outliers.txt")
cat("==========================\n")
