...
sink("sars_cov_1_output_r_regression_path.txt")
cat("===========================\n")
...
sink("sars_cov_1_output_r_regression_path_time.txt")
cat("=================\n")
cat("Regression (Null)\n")
cat("=================\n\n")
summary(pgls_null)
...
sink("sars_cov_1_output_r_regression_path_time_node.txt")
cat("========================\n")
...
sink("sars_cov_1_output_r_regression_path_time_node_interaction_time.txt")
cat("========================\n")
cat("Regression (Alternative)\n")
cat("========================\n\n")
summary(pgls_time)
...
models <- NULL
models[[1]] <- pgls_alt
sink("sars_cov_1_output_r_variance_inflation_factors.txt")
cat("==========================\n")
