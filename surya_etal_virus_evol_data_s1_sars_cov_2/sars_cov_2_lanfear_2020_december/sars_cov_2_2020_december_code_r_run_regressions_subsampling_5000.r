...
for (subs in 1:100) {
  ...
  ## Save results
  setwd("sars_cov_2_2020_december_subsampling_5000")
  sink(
...
sink("sars_cov_2_2020_december_output_r_regression_subsampling_5000.txt")
cat("=====\n")
cat("Delta\n")
cat("=====\n\n")
...
sink(
  "sars_cov_2_2020_december_output_r_regression_subsampling_5000.txt",
  append = TRUE
)
cat("======\n")
cat("Beta 0\n")
