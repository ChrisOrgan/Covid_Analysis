...
sink("surya_wduplicates_R_output_regression_punctuation_intercept_lambda1_no_outliers.txt")
cat("=================================\n")
...
sink("surya_wduplicates_R_output_regression_punctuation_lambda1_no_outliers.txt")
cat("================\n")
