...
sink("surya_wduplicates_R_output_node_density_artifact.txt")
cat("=================\n")
...
# Save scatter plots ----
CairoPDF("surya_wduplicates_figure_punctuation_node_density_artifact.pdf",
         width = 3.2675, height = 3.2675)
print(plot_bias)
graphics.off()
CairoSVG("surya_wduplicates_figure_punctuation_node_density_artifact.svg",
         width = 3.2675, height = 3.2675)
print(plot_bias)
graphics.off()
