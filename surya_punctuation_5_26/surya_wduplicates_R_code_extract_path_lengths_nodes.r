...
write.table(
  dat,
  file = "surya_wduplicates_R_data_path_lengths_nodes.txt",
  quote = FALSE,
  sep = "\t",
  row.names = FALSE,
  col.names = FALSE
...
write.table(
  dat_int,
  file = "surya_wduplicates_R_data_path_lengths.txt",
  quote = FALSE,
  sep = "\t",
  row.names = FALSE,
  col.names = FALSE
...
write.table(
  dat_region,
  file = "surya_wduplicates_R_data_path_lengths_nodes_region.txt",
  quote = FALSE,
  sep = "\t",
  row.names = FALSE,
  col.names = FALSE
