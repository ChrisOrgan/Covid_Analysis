...
dat$fitted_values <- 0.0001207442 + 0.00004814203*dat$node
...
ggsave("surya_figure_cipres_punctuation_diagnostics.pdf", width = 5,
       height = 4, device = cairo_pdf, plot_diag)
graphics.off()
ggsave("surya_figure_cipres_punctuation_diagnostics.svg", width = 5,
       height = 4, plot_diag)
graphics.off()
