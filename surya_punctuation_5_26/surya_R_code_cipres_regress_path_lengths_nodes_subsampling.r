...
for (subs in 1:1000) {
  ...
  sink(paste("surya_R_output_cipres_subsampling_", subs, ".txt", sep = ""))
  cat("======================\n")
  ...
  list_se1[subs] <- se_b1
  list_p[subs] <- p_val
  sink("surya_R_output_cipres_subsampling_beta0.txt", append = TRUE)
  cat(paste(beta0, "\n", sep = ""))
  sink()
  sink("surya_R_output_cipres_subsampling_beta1.txt", append = TRUE)
  cat(paste(beta1, "\n", sep = ""))
  sink()
  sink("surya_R_output_cipres_subsampling_var.txt", append = TRUE)
  cat(paste(sig2, "\n", sep = ""))
  sink()
  sink("surya_R_output_cipres_subsampling_r2.txt", append = TRUE)
  cat(paste(r2, "\n", sep = ""))
  sink()
  sink("surya_R_output_cipres_subsampling_se0.txt", append = TRUE)
  cat(paste(se_b0, "\n", sep = ""))
  sink()
  sink("surya_R_output_cipres_subsampling_se1.txt", append = TRUE)
  cat(paste(se_b1, "\n", sep = ""))
  sink()
  sink("surya_R_output_cipres_subsampling_p.txt", append = TRUE)
  cat(paste(p_val, "\n", sep = ""))
  sink()
  setwd("..")
}
...
sink("surya_R_output_cipres_subsampling_results.txt")
cat("=========\n")
cat("Intercept\n")
cat("=========\n\n")
...
sink("surya_R_output_cipres_subsampling_results.txt", append = TRUE)
cat("=====\n")
cat("Slope\n")
cat("=====\n\n")
