...
dat <- read.table("surya_wduplicates_R_data_path_lengths_nodes.txt", sep = "\t")
...
for (subs in 1:1000) {
  ...
  sink(paste("surya_wduplicates_R_output_subsampling_", subs, ".txt", sep = ""))
  cat("======================\n")
  ...
  list_se1[subs] <- se_b1
  list_p[subs] <- p_val
  sink("surya_wduplicates_R_output_subsampling_beta0.txt", append = TRUE)
  cat(paste(beta0, "\n", sep = ""))
  sink()
  sink("surya_wduplicates_R_output_subsampling_beta1.txt", append = TRUE)
  cat(paste(beta1, "\n", sep = ""))
  sink()
  sink("surya_wduplicates_R_output_subsampling_var.txt", append = TRUE)
  cat(paste(sig2, "\n", sep = ""))
  sink()
  sink("surya_wduplicates_R_output_subsampling_r2.txt", append = TRUE)
  cat(paste(r2, "\n", sep = ""))
  sink()
  sink("surya_wduplicates_R_output_subsampling_se0.txt", append = TRUE)
  cat(paste(se_b0, "\n", sep = ""))
  sink()
  sink("surya_wduplicates_R_output_subsampling_se1.txt", append = TRUE)
  cat(paste(se_b1, "\n", sep = ""))
  sink()
  sink("surya_wduplicates_R_output_subsampling_p.txt", append = TRUE)
  cat(paste(p_val, "\n", sep = ""))
  sink()
  setwd("..")
}
...
sink("surya_wduplicates_R_output_subsampling_results.txt")
cat("=========\n")
cat("Intercept\n")
cat("=========\n\n")
cat(paste("Percentile (2.50th) = ", beta0_025, "\n", sep = ""))
...
sink("surya_wduplicates_R_output_subsampling_results.txt", append = TRUE)
cat("=====\n")
cat("Slope\n")
cat("=====\n\n")
cat(paste("Percentile (2.50th) = ", beta1_025, "\n", sep = ""))
...
cat("R-squared\n")
cat("=========\n\n")
cat(paste("Percentile (2.50th) = ", r2_025, "\n", sep = ""))
cat(paste("Median = ", r2_500, "\n", sep = ""))
cat(paste("Percentile (97.5th) = ", r2_975, "\n\n", sep = ""))
sink()
p_025 <- as.numeric(quantile(list_p, 0.025))
...
cat("P value\n")
cat("=======\n\n")
cat(paste("Percentile (2.50th) = ", p_025, "\n", sep = ""))
