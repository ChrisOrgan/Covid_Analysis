...
sink("sarbecovirus_output_r_regression_path_v2_without_outliers.txt")
cat("===========================\n")
...
sink("sarbecovirus_output_r_regression_path_time_v2_without_outliers.txt")
cat("=================\n")
cat("Regression (Null)\n")
cat("=================\n\n")
summary(pgls_null)
...
sink("sarbecovirus_output_r_regression_path_time_node_v2_without_outliers.txt")
cat("========================\n")
...
sink(
  "sarbecovirus_output_r_regression_path_time_node_interaction_time_v2_without_outliers.txt"
)
cat("========================\n")
cat("Regression (Alternative)\n")
cat("========================\n\n")
...
models <- NULL
models[[1]] <- pgls_alt
sink("sarbecovirus_output_r_variance_inflation_factors_v2_without_outliers.txt")
cat("==========================\n")
