...
dat$fitted_values <- 0.1606673 + 0.00002166796*dat$node
...
ggsave("surya_figure_punctuation_sars_like_diagnostics_r.pdf", width = 5,
       height = 4, device = cairo_pdf, plot_diag)
graphics.off()
ggsave("surya_figure_punctuation_sars_like_diagnostics_r.svg", width = 5,
       height = 4, plot_diag)
graphics.off()
